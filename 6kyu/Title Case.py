...
be lowercase except for the first word in the string. The JavaScript/CoffeeScript tests will
...
def title_case(title, minor_words=''):
    ...
    return ' '.join(char if char in minor_words else char.capitalize() for char in title)
